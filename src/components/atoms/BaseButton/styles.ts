  ...
  'flex items-center justify-center rounded-lg',
  {
    variants: {
      color: {
        ...
        neutralMedium: `absolute text-gray-400 group-has-[:focus]:text-gray-900 group-has-[:disabled]:text-gray-200 group-has-[:hover]:text-gray-500 dark:group-has-[:focus]:text-gray-200 dark:group-has-[:disabled]:text-gray-500 dark:group-has-[:hover]:text-gray-200`,
        redNoBgInput:
