...
export const baseInputStyles = cva(
  `peer p-2 flex text-sm rounded-lg outline-none border 
    h-10 disabled:border-neutral-300 dark:text-white disabled:placeholder-neutral-400 disabled:opacity-50 dark:border-neutral-400 dark:placeholder-neutral-500  dark:bg-neutral-700  dark:disabled:border-neutral-500 dark:disabled:placeholder-neutral-500`,
  {
    variants: {
      intent: {
