...
export const baseOtpStyles = cva(
  'block rounded-lg outline-none text-center size-10 sm:size-14 bg-white dark:bg-transparent dark:disabled:border-neutral-500 dark:disabled:text-neutral-500 dark:text-neutral-500 dark:border-neutral-400 disabled:text-neutral-300 disabled:border-neutral-300 text-base',
  {
    variants: {
      intent: {
        default:
